...
namespace handler
{
    ...
    public:
        auto InitializeSession(
            ...
            roleplay_bot::ai::InitializeSessionResponse *response) -> grpc::Status override;

        auto GetSessionConfig(
            grpc::ServerContext *context,
            const roleplay_bot::ai::GetSessionConfigRequest *request,
            roleplay_bot::ai::GetSessionConfigResponse *response) -> grpc::Status override;

        auto WriteStory(
            grpc::ServerContext *context,
            const roleplay_bot::ai::WriteStoryRequest *request,
            roleplay_bot::ai::WriteStoryResponse *response) -> grpc::Status override;

        auto GetStoryHistory(
            grpc::ServerContext *context,
            const roleplay_bot::ai::GetStoryHistoryRequest *request,
            roleplay_bot::ai::GetStoryHistoryResponse *response) -> grpc::Status override;
